...
export default function EditArtistProfile({ navigation }) {
  ...
  const [featuredArtUrl, setFeaturedArtUrl] = useState(
    userData.featuredArtUrl || ""
  );
  ...
  const saveChanges = async () => {
    try {
      ...
      if (featuredArtUrl && featuredArtUrl.startsWith("file://")) {
        formData.append("featuredArtUrl", {
          uri: featuredArtUrl,
          name: `featuredArt.jpg`,
          type: `image/jpeg`,
        });
      } else {
        formData.append("featuredArtUrl", featuredArtUrl);
      }
      ...
      <ScrollView contentContainerStyle={styles.scrollContainer}>
        <View style={styles.profileContainer}>
          <TouchableOpacity onPress={selectImage}>
            <Image
              source={avatar ? { uri: avatar } : userData.defaultAvatar}
